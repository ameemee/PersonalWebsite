...
const LightDarkModeMUISwitch = styled(Switch)(
  ({ theme }: { theme: Palette }) => ({
    width: 62,
    height: 34,
    padding: 7,
    ...
    // border: "solid",
    // refer to https://mui.com/material-ui/api/switch/#classes for class info!
    ...
    "& .MuiSwitch-thumb": {
      ...
      backgroundColor: theme.mode === "dark" ? "coral" : "steelblue",
      width: 32,
      height: 32,
      "&::before": {
        content: "''",
...
export default LightDarkModeMUISwitch;
